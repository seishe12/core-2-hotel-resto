            ...
            <form role="form" id="booking" data-toggle="validator">
                ...
                <div class="col-lg-12">
                    ...
                    <?php } else{?>
                        <div class="panel panel-default">
                            <div class="panel-heading">Room Information:
                                <a class="btn pull-right" href="../dashboard.php">Return To Dashboard</a>
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <a class="btn btn-primary" style="border-radius:60px;" href="../room_mang.php"><i class="fa fa-check-circle"></i></a>
            </div>
        </div>
